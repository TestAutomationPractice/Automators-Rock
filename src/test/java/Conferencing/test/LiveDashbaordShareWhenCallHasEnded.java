...
public class LiveDashbaordShareWhenCallHasEnded extends Base{
	...
	public void sharedUserRovokeRestoreLD() throws Throwable, Exception {
		...
		participantsDashboardPage.verifyCallStatus(CallStatus.Call_Ended.getCallstatus());

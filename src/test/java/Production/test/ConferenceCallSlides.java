...
public class ConferenceCallSlides extends Base {

	private static String automationShowName = "AutoConfCallSlides01" + ComponentBase.dateTime();
	private static String confCallName = "ConfCallSlides" + ComponentBase.dateTime();
	private String entryCode = "EC" + generateNumInStringFormat(10);
	String[] investorUrl;
	String conferenceEventId;

	public ConferenceCallSlides() {
	...
	@Test(description = "Verify creation of Conference Call + Slides show", enabled = true)
	@CustomTestAnnotations(testCaseNumber = "TC-104")
	public void creatConferenceCallSlidesShow() throws Throwable, Exception {
	...
	@Test(description = "Verify adding Entry code in MyNrs Page and launching live dashboard for Conference Call + Slides show", enabled = true, dependsOnMethods = {"creatConferenceCallSlidesShow" })
	@CustomTestAnnotations(testCaseNumber = "TC-104")
	public void verifyEntryCodeLaunchLiveDashboardForConferenceCallSlidesShow() throws Throwable, Exception {
		CommonTestDataDto testDataDto = commonTestData.get();
		RemoteWebDriver driver = testDataDto.getDriver();
		Log4JLogger logger = testDataDto.getLogger();
		TestDataHelper testDataHelper = testDataDto.getTestDataHelper();

...
public class SlideOnlyShow extends Base {

	private String automationShowName = "AutoDocSlideOnly" + generateNumInStringFormat(4)+ ComponentBase.dateTime();
	private String entryCode = "EC" + generateNumInStringFormat(10);
	String count ;
	
	public SlideOnlyShow() {
	...
	@Test(description = "Verify adding Entry Code", enabled = true, dependsOnMethods = {
			"createshow" })

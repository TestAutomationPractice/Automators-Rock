...
public class ConferenceCall_ShareLiveDashboard_DP extends Base {

	private static String automationShowName = "AutoConfCallProd1" + ComponentBase.dateTime();
	private static String confCallName = "ConfCallProd" + ComponentBase.dateTime();
	// private String phnno = generateNumInStringFormat(10);
	private String hostphnno = generateNumInStringFormat(10);
	private String legacyphnno = generateNumInStringFormat(10);
	private String legacyintphnno = generateNumInStringFormat(10);
	...
	public ConferenceCall_ShareLiveDashboard_DP() {
	...
	public void createCFNCall() throws Throwable, Exception {
		...
		// confCall.enterAutomatedDialinNumber(phnno);
		confCall.enterhostDialInNumber(hostphnno);
		confCall.enterlegacyDialInNumber(legacyphnno);
		confCall.enterlegacyDialInNumberInter(legacyintphnno);
		Thread.sleep(5000);
		confCall.clickAdd();

...
public class ConferenceCall_ShareShow extends Base {

	private static String automationShowName = "AutoConfCallProd2" + ComponentBase.dateTime();
	...
	public ConferenceCall_ShareShow() {

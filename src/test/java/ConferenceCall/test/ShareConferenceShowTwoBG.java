...
public class ShareConferenceShowTwoBG extends Base {

	private static String automationShowName = "AutoConfCall3" + ComponentBase.dateTime();
	...
	public ShareConferenceShowTwoBG() {
	...
	public void createConfCall() throws Throwable, Exception {
		...
		showdetails.selectBusinessGroup(testDataHelper.getValue("BusinessGroup2"));
		...
		documentaion.selectBusinessGroup(testDataHelper.getValue("BusinessGroup"));
		...
		confCall.selectBusinessGroup(testDataHelper.getValue("BusinessGroup"));

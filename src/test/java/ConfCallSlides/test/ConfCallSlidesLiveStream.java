...
public class ConfCallSlidesLiveStream extends Base {

	private String automationShowName = "AutoConfCallSlides" + generateNumInStringFormat(4) + ComponentBase.dateTime();
	private String confCallName = "ConfCall" + ComponentBase.dateTime();
	private String entryCode = "EC" + generateNumInStringFormat(10);
	private String directLink = "";
	
	public ConfCallSlidesLiveStream() {
	...
	@Test(description = "Verify Conference Call + Slides Creation", enabled = true)
